...
<div class="display-flex">
	...
	<div class="flex-stretch">
		...
		<form action="notes/cart_actions.php?action=delete-cart-item" method="post">
	...
	<div class="flex-none">
		...
		<form action="notes/cart_actions.php?action=update-cart-item" method="post" onchange="this.submit()">
			<input type="hidden" name="id" value="$o->id">
